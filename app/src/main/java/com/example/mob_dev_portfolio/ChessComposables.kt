...
//        Log.d("updatePromotionPiece", "promotionData: ${promotionData.value}")
        ...
        if (promotionData.value.midPromotion) {
            Log.d("updatePromotionPiece", "midPromotion is true: ${promotionData.value}")
...
fun PromotionChoice(
    ...
    if (promotionData.value.pawnSquare == null || promotionData.value.promotionSquare == null || !promotionData.value.midPromotion) {
        return
    }
